<template>
    <div class="top">
        <div class="top__left">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 200 200" fill="var(--green)">
                <circle class="cls-1" cx="68.5" cy="68.5" r="70"/>
        ...
        <div class="nav">
            ...
            <router-link class="link" to="/about">Blog</router-link>
            <router-link class="link__last" to="/about">Resume</router-link>
        </div>
    </div>
</template>
...
export default {
    methods: {
        ...
        //         gsap.to("h2", {text:"Kevin Jordan", ease:"power1.in", duration:2})
